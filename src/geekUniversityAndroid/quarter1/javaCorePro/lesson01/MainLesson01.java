package geekUniversityAndroid.quarter1.javaCorePro.lesson01;
  ...
  /*
	    ...
	    Дата правки:    16.07.2020
  */

import geekUniversityAndroid.quarter1.javaCorePro.lesson01.box.TestBox;
...
public class MainLesson01 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("1 Задание. - Написать метод, который меняет два элемента массива местами");
        ...
        */
        ...
        int testIndex = 1;
        System.out.println();
        System.out.println("2 Задание. -  Написать метод, который преобразует массив в ArrayList");
         ...
         */
        System.out.println();
        System.out.println("3 Задание. -  Большая задача");
        new TestBox().run();
    }
